...
import { JSIdent, JSImportPath } from "./framework";
import {
  Registry,
  resolveEnumTypeName,
...
function findLocation(
  file: descriptor_pb.FileDescriptorProto,
  path: number[]
): Location {
...
function normaliseFieldObjectName(name: string): string {
  switch (name) {
    case "abstract":
    case "boolean":
    case "break":
