...
function generateMessage(g: protogen.GeneratedFile, message: protogen.Message, lvl: number) {
...
function generateEnum(g: protogen.GeneratedFile, enumType: protogen.Enum, lvl: number) {
...
function generateExtension(g: protogen.GeneratedFile, extension: protogen.Extension) {
...
function collectMessages(fm: protogen.File | protogen.Message): protogen.Message[] {
